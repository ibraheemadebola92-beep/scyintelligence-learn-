...
# ══════════════════════════════════════
    ...
    if st.button("Teach Me 🚀"):
        ...
        system = f"You are an expert university tutor for 100-Level Engineering students in Nigeria. Course: {course}. Topic: {topic}. Teach clearly with: 1. Simple explanation 2. Detailed breakdown 3. 2 worked examples 4. Exam tips."
