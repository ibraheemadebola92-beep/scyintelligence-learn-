...
.mode-card:hover { border-color: #00ff88; background: rgba(0,255,136,0.06); }
.mode-icon { font-size: 2.5rem; margin-bottom: 12px; }
.mode-title { font-family: 'Syne', sans-serif; font-size: 1.4rem; font-weight: 700; color: #e8e8f0; margin-bottom: 6px; }
.mode-desc { color: #a0a0b0; font-size: 0.95rem; line-height: 1.5; }
